...
set(GAZEBO_VERSION 9.0)
set(GAZEBO_MAJOR_VERSION 9)

set(GAZEBO_PLUGIN_PATH "/usr/lib/x86_64-linux-gnu/gazebo-9/plugins")
...
list(APPEND GAZEBO_INCLUDE_DIRS /usr/include/gazebo-9)

list(APPEND GAZEBO_LIBRARY_DIRS /usr/lib/x86_64-linux-gnu)
list(APPEND GAZEBO_LIBRARY_DIRS /usr/lib/x86_64-linux-gnu/gazebo-9/plugins)

list(APPEND GAZEBO_CFLAGS -I/usr/include)
list(APPEND GAZEBO_CFLAGS -I/usr/include/gazebo-9)
...
# Find boost
find_package(Boost 1.40.0 REQUIRED thread signals system
...
list(APPEND GAZEBO_LDFLAGS -Wl,-rpath,/usr/lib/x86_64-linux-gnu/gazebo-9/plugins)
list(APPEND GAZEBO_LDFLAGS -L/usr/lib/x86_64-linux-gnu)
list(APPEND GAZEBO_LDFLAGS -L/usr/lib/x86_64-linux-gnu/gazebo-9/plugins)
