...
bool OctomapFromGazeboWorld::CheckIfInterest(const ignition::math::Vector3d& central_point,
  ...
  start_point.Set(start_point.X()+leaf_size/2,start_point.Y(),start_point.Z());
  end_point.Set(end_point.X()-leaf_size/2,end_point.Y(),end_point.Z());
  ...
  start_point.Set(start_point.X(),start_point.Y()+leaf_size/2,start_point.Z());
  end_point.Set(end_point.X(),end_point.Y()-leaf_size/2,end_point.Z());
  ray->SetPoints(start_point, end_point);
  ray->GetIntersection(dist, entity_name);
  ...
  start_point = central_point;
  end_point = central_point;
  start_point.Set(start_point.X(),start_point.Y(),start_point.Z()+leaf_size/2);
  end_point.Set(end_point.X(),end_point.Y(),end_point.Z()-leaf_size/2);
  ray->SetPoints(start_point, end_point);
  ray->GetIntersection(dist, entity_name);
